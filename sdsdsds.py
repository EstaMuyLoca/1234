...
if __name__ == "__main__":
    # Пример 1: Смешанный текст
    print("Пример 1: Смешанный текст")
    result = speaker_silero("Привет, Hello! Как дела? How are you?")
    print(result)
    
    # Пример 2: Только русский
    print("\nПример 2: Только русский")
    result = speaker_silero("Это полностью русский текст")
    print(result)
    
    # Пример 3: Только английский
    print("\nПример 3: Только английский")
    result = speaker_silero("This is completely English text")
    print(result)
    
    # Пример 4: Сложный смешанный текст
    print("\nПример 4: Сложный смешанный текст")
    result = speaker_silero("Мой email: example@test.com, website: https://example.org. Python - лучший programming language!")
    print(result)